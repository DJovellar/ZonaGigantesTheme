            ...
            <div class="row">
                <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                    ...
                    <div class="row pt-3 lead">
                        ...
                        <div class="col-2 col-sm-2 col-md-2 col-lg-1 col-xl-1 text-center">15 <img src="<?php bloginfo('template_url');?>/images/other-icons/comment-icon.png" class="img-fluid" height="20" width="15"></div>
                    </div>
                    <hr>
